...
class VrepEnv(gym.Env):
	...
	def load_scene(self, scene_path):
		...
		self.RAPI_rc(vrep.simxLoadScene(self.cID,scene_path,0, vrep.simx_opmode_blocking)) # 0
	...
	def obj_read_proximity_sensor(self, handle):
		returnCode,detectionState, points,_,_ = vrep.simxReadProximitySensor( self.cID,handle, self.opM_get)
